    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <video
          ...
          playsInline
          preload="none"
          className="absolute inset-0 w-full h-full object-cover opacity-50 invert grayscale contrast-125 brightness-110"
        >
          <source src="/media/map.mp4" type="video/mp4" />
        </video>
        <div className="absolute inset-0 bg-gradient-to-b from-slate-50/50 via-slate-50/70 to-slate-50/90"></div>
        <div className="absolute inset-0 bg-[url('/textures/noise.svg')] opacity-5 mix-blend-multiply"></div>
      </div>
